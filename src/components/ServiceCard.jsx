...
const ServiceCard = () => {
  return (
    <div className="grid grid-col-1 w-screen h-screen gap-[600px]  px-auto py-auto justify-center place-content-center">
      {services.map((service) => (
        <div className=" list-none bg-cover w-[500px] px-auto py-auto h-[500px] mt-[-20em] rounded-[10%] p-[10%] m-5 bg-primary">
          <li key={service.id}>
